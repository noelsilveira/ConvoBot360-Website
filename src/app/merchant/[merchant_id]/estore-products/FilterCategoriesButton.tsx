...
const FilterCategoriesButton = () => {
  ...
  return (
    <button
      type='button'
      className='-mb-0.5 -mr-2 ml-2 inline-flex items-center justify-center gap-1 px-2 text-xs font-medium text-gallery-600 hover:text-gallery-700 sm:ml-5 lg:hidden'
