      ...
      <div className='relative overflow-hidden pt-16'>
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          ...
          <div className='relative' aria-hidden='true'>
            <div className='absolute -inset-x-20 bottom-0 bg-gradient-to-t from-white via-white pt-[35%]' />
          </div>
        </div>
      </div>
      <div className='mx-auto mt-4 max-w-7xl px-6 sm:mt-20 md:-mt-20 lg:px-8'>
