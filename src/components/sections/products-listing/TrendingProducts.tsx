...
const TrendingProducts = () => {
  return (
    <section aria-labelledby='trending-heading'>
      <div className='mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-6 lg:px-8 lg:pt-6'>
        <div className='md:flex md:items-center md:justify-between'>
          ...
          <a
            href='#'
            className='hidden text-sm font-medium text-brand-600 hover:text-brand-500 md:block'
          >
            Shop the collection
